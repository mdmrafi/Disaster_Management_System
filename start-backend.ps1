$here = "C:\Users\MashRaFi\OneDrive\Desktop\New folder\disaster-management\backend"
$log = "C:\Users\MashRaFi\OneDrive\Desktop\New folder\disaster-management\backend\run.log"
